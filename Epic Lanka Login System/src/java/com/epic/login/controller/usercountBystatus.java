...
@WebServlet(urlPatterns = "/getcountbystatus")

public class usercountBystatus extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        String count=registrationDao.getCountBystatus(req.getParameter("status"));
